	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name">Farhan Technology</div>
				<div class="profile-usertitle-status">infoftsbd.net@gmail.com</div>
			</div>
			<div class="clear"></div>
		</div>
	 ...
	 <li class="parent "><a data-toggle="collapse" href="#sub-item-27">
		...
		<ul class="children collapse" id="sub-item-27">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-4">
				<em class="fa fa-navicon">&nbsp;</em> FT Solution <span data-toggle="collapse" href="#sub-item-4" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-5">
				<em class="fa fa-navicon">&nbsp;</em>Metal Detector <span data-toggle="collapse" href="#sub-item-5" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-7">
				...
				<ul class="children collapse" id="sub-item-7">
					<li> <i class="fas fa-hand-pointer"></i><a class=""href="{{ route('ups') }}"><span class="fa fa-arrow-right">&nbsp;</span> IPs,UPS Add</a></li>
				</ul>
